...
define('INVENTORY_FILE_NAME',        'yuba-harvest-inventory.csv');
...
function AutoFill() {
   $stream = '';
      $stream .= '<select name="AutoFill" OnChange="document.form1.submit();">';
...
/*
 ...
 to get from PST to Zulu time, add 7 hours 
...
*/
 function DownloadPaymentsReport($begin_date,$end_date) {
  ...
  //$bdd = date('m-d-Y',$begin_date_time);
  //$edd = date('m-d-Y',$end_date_time);
  
  //$filename = "square-json/From $bdd to $edd";
  //$fh = fopen($filename,'w');
  //fclose($fh);
